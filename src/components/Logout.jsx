...
const Logout = ({profileUrl, logout}) => {
  return (
    <section className="logout">
      ...
      <div className='flex flex-col-reverse lg:flex lg:flex-row lg:items-center lg:justify-between lg:rounded-md lg:mb-2 bg-bg-input'>
        ...
        <button type="button" className=' px-3 py-2 cursor-pointer duration-300 transition-all hover:bg-orange-600 rounded-md'>
          <NavLink tag={Link} to="profile">
            <img
              className='w-16 h-16 lg:w-10 lg:h-10 lg:w-9 lg:h-9 rounded-full bg-white object-cover object-center'
