      ...
      <div className="mt-24 mb-20">
        ...
        <div className=" mt-8 mx-6 flex flex-1 space-between gap-[5vw] lg:gap-[12vw]">
          <div className="flex flex-1 flex-col gap-4">
            ...
            <button className="bg-orange-600 cursor-pointer transition-all hover:bg-orange-500 outline-none focus:outline-orange-600 border-0 rounded-md max-w-xs p-2 lg:p-3"><NavLink tag={Link}  activeclassname="active" to="/placeOrder">PROCEED TO CHECKOUT</NavLink></button>
          </div>
